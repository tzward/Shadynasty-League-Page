...
<div class="constitution">
    <h1 class="noUnderscore">SHADYNASTY LEAGUE CONSTITUTION</h1>
    ...
    <h3 class="noUnderscore clickable" on:click={() => goToSection(eight)}>Section 8: League Rule Changes</h3>
    
        <h4 class="noUnderscore clickable" on:click={() => goToSection(eightOne)}>7.1 Rule Change Process</h4>
    ...
    <p>Trading of players and draft picks (up to 3 drafts away) are allowed. Trades will have a 1 day approval process and will be reversed if vetoed or under investigation for collusion. Tradable assets include players, draft picks, and FAAB $.</p>
    ...
    <div class="subBlock">
        <p>The trade deadline will be set for the end of the week 12 games of the NFL season.</p>
    </div>
    ...
    <div class="subBlock">
        <p>A total of 6 veto votes are required to veto a trade. Vetoes are only appropriate in instances of collusion or an egregious mismatch of inherent value (i.e. ). Not liking a trade does not warrant a veto.</p>
    </div>
    ...
    <p>FAAB Waiver wire system. Each team will begin the season with $100. $0 bids are allowed. Bids will process Wednesdays and Sundays at 3AM EST.</p>

    <p>FAAB budgets will reset each season in February after the Super Bowl.</p>
    
    
    <h2 class="sectionHeading" bind:this={two}>Section 2 Drafting</h2>
    
    <h3 bind:this={twoOne}>2.1 Draft Order</h3>
    <p>The draft order each year will be a linear draft, the positions of which are determined by two factors:</p>
        <p>Positions 1 through 4 - In reverse order of the previous year’s Max Points For Standings.</p>
        <p>Positions 5 through 10 - In reverse order of the previous year’s Playoff finishes, tiebreakers go to regular season Max Points For Standings.</p>

    <h3 bind:this={twoTwo}>2.2 Rookie Drafts</h3>
    <p>Rookie drafts will consist of 4 rounds of drafting, with 5 minutes alotted for each pick. At the start of the first game of NFL Week 1, you will need to have cut the necessary players to change your lineup.</p>
    ...
    <p>The league scoring system breakdown is listed on the Sleeper fantasy app (for the most part, it follows typical 1PPR Scoring, 4pt Passing TD). The scoring system will never change without a majority league vote.</p>
    ...
    <h2 class="sectionHeading" bind:this={eight}>Section 8 League Rule Changes</h2>
    
    <h3 bind:this={sevenOne}>8.1 Rule Change Process</h3>
    <p>Rule changes will happen once per league cycle, before the rookie draft. During this time, managers are encouraged to represent a change to a rule structure for the next season. Once a rule is nominated, the league will vote on whether or not they want the rule added to the upcoming season. A 70% majority is required to pass any given rule.</p>
